...
易卦（YiGua）是一个集成了人工智能技术的现代化易学知识平台，融合了传统易学智慧与现代科技。系统支持六爻、大六壬、奇门遁甲、紫微斗数等多种易学术数，提供智能问答、知识检索、占卜解析等功能。

### ✨ 核心特性

- 🔮 **智能易学问答** - 基于RAG技术的AI问答系统
- 📚 **海量知识库** - 191本易学典籍，104个成功处理的文档
- 📱 **跨平台应用** - Flutter开发，支持Android/iOS/Web
- 🚀 **高性能架构** - 74,685 QPS并发能力，2.3ms查询响应
- 💾 **离线优先** - 本地缓存，离线可用，智能同步
- 🎯 **精准分类** - 8大易学分类体系，371个专业关键词
